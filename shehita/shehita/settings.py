"""
Django settings for shehita project.
...
SECRET_KEY = 'django-insecure-)al2onz%$$g3ug=4)dp&@5@35!e93@6cwu_sr7z4oa)@genvo8'
...
WSGI_APPLICATION = 'shehita.wsgi.application'
